...
# species 2
# upside down bonding 1
pair_coeff 7 11 lj/expand {epsilon2} {sigma} {shift} {wcacut-shift}
pair_coeff 9 9 lj/expand {epsilon2} {sigma} {shift} {wcacut-shift}
pair_coeff 7 9 lj/expand {epsilon2} {sigma} {shift} {wcacut-shift}
pair_coeff 7 7 lj/expand {epsilon2} {sigma} {shift} {wcacut-shift}
pair_coeff 9 11 lj/expand {epsilon2} {sigma} {shift} {wcacut-shift}
pair_coeff 11 11 lj/expand {epsilon2} {sigma} {shift} {wcacut-shift}

# upside down bonding 2
pair_coeff 8 12 lj/expand {epsilon2} {sigma} {shift} {wcacut-shift}
pair_coeff 10 12 lj/expand {epsilon2} {sigma} {shift} {wcacut-shift}
pair_coeff 12 12 lj/expand {epsilon2} {sigma} {shift} {wcacut-shift}
pair_coeff 8 10 lj/expand {epsilon2} {sigma} {shift} {wcacut-shift}
pair_coeff 10 10 lj/expand {epsilon2} {sigma} {shift} {wcacut-shift}
pair_coeff 8 8 lj/expand {epsilon2} {sigma} {shift} {wcacut-shift}
...
# species 2
# correct bonding
pair_coeff 7 8 lj/expand {epsilon} {sigma} {shift} {ljcut-shift} 
pair_coeff 9 10 lj/expand {epsilon} {sigma} {shift} {wcacut-shift} 
pair_coeff 11 12 lj/expand {epsilon} {sigma} {shift} {ljcut-shift}
pair_coeff 7 10 lj/expand {epsilon} {sigma} {shift} {wcacut-shift}
pair_coeff 7 12 lj/expand {epsilon} {sigma} {shift} {wcacut-shift}
