...
from utils.curvsim.v2.interactionGen import setMultitypeInteractions
...
"""
                    general_unattractive = {'epsilon': epsilon, 'sigma': sigma, 'shift': shift, 'wcacut': wcacut}
                    flanks_attractive = {'epsilon_flanks': epsilon_flanks, 'sigma_flanks': sigma_flanks, 'shift_flanks': shift_flanks, 'ljcut_flanks': ljcut_flanks}
                    mid_unattractive = {'epsilon_mid': epsilon, 'sigma_mid': sigma, 'shift_mid': shift, 'ljcut_mid': wcacut} 

                    inputcontents += setMultitypeInteractions(labels=labels, allowedattractions=allowedattractions, general_unattractive=general_unattractive, flanks_attractive=flanks_attractive, mid_attractive=mid_unattractive)
                
                    inputcontents += f"""pair_modify shift yes
"""
                elif beta == 1:
...
"""
                    general_unattractive = {'epsilon': epsilon, 'sigma': sigma, 'shift': shift, 'wcacut': wcacut}
                    flanks_unattractive = {'epsilon_flanks': epsilon, 'sigma_flanks': sigma, 'shift_flanks': shift, 'ljcut_flanks': wcacut}
                    mid_attractive = {'epsilon_mid': epsilon_mid, 'sigma_mid': sigma_mid, 'shift_mid': shift_mid, 'ljcut_mid': ljcut_mid} 

                    inputcontents += setMultitypeInteractions(labels=labels, allowedattractions=allowedattractions, general_unattractive=general_unattractive, flanks_attractive=flanks_unattractive, mid_attractive=mid_attractive)
...
"""
                    ...
                    inputcontents += setMultitypeInteractions(labels=labels, allowedattractions=allowedattractions, general_unattractive=general_unattractive, flanks_attractive=flanks_attractive, mid_attractive=mid_attractive)
