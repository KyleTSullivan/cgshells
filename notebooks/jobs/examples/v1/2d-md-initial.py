...
for i in range(len(phi_list)):   
    for j in range(len(temp_list)):
        ...
        for k in range(len(kh_list)):  
            ...
            ### Interactions
            pair_ints = "repulsive" #"none", "repulsive", "1patch", "patchy", "attractive", or "2attractive"
            soft_ints = False
            sigma = 0.25*dcore
    ...
    #         maxiter = 100000
            ...
            simpath = f"data/examples/{int(dimension)}d/md/wx-{wx:0.3f}-t0-{t0:0.3f}-Nbeads-{Nbeads}/nshells-{nshells}/r0-{r0string}/phi-{phi:0.3f}/initial" # path to simulation directory (relative to PROJECT_ROOT)
