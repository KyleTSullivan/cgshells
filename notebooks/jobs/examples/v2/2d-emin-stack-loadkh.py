...
dcore = 1.0
nshells_list = np.arange(1, 50+1).tolist()    # independent jobs that run in parallel (must be list)
curvetypes = {'A': (6 * dcore)}
specieslist = ['A']
...
kh_list = [200, 300, 400, 500, 600, 700, 800, 900, 1000, 1100]    # jobs that will run in series (must be list)
# start job from these final states (must be list)
kh_loadlist = [100, 200, 300, 400, 500, 600, 700, 800, 900, 1000]
minstyle_load = "cg"
etol_load = 1e-12
