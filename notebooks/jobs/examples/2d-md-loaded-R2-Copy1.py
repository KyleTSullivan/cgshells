...
phi_list = [0.20,0.25,0.3,0.35,0.4]    # independent jobs that run in parallel (must be list)
temp_list = [0.07,0.08,0.09]    # more independent jobs that run in parallel (must be list)
