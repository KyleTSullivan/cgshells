...
nshells_list = [2,4,6,8,10]    # independent jobs that run in parallel (must be list)
kh_list = [500,1000]    # dependent jobs that run in series (must be list)
kh_loadlist = [100,500]    # start job from these final states (must be list)
