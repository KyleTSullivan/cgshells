...
# also can calculate and record inter-particle gaps
...
#     kh_list = "all"
    ...
    r0 = 20 * dcore   # RMS radius of curvature; set to "flat" for planar plates 
    alpha = 0.0 * np.pi/4    # shape 'angle' (0 = cylinder w/ curvature in x; pi/4 = sphere; -pi/4 = saddle) 
