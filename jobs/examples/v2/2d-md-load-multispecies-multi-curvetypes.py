...
for i in range(len(phi_list)):   
    for j in range(len(temp_list)):
        ...
        for k in range(len(kh_list)):  
            ...
            r0 = [3.0 * dcore, 7.5 * dcore, 'flat']
            #weightedaveragecurves = [0.5, 0.5] # weighted average between listed curves in r0. Must add up to one.
            weightedaveragecurves = [0.25, 0.25, 0.5]
            labels = ['A', 'B', 'C']
