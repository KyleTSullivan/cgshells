...
for i in range(len(phi_list)):   
    for j in range(len(temp_list)):
        ...
        for k in range(len(kh_list)):  
            ...
            weightedaveragecurves = [0.334, 0.333, 0.333] # weighted average between listed curves in r0. Must add up to one.
            ...
            simtype = "md"
            datascript = "lattice-1species-mixed-curves"    # script to make data file with, NO .py EXTENSION
