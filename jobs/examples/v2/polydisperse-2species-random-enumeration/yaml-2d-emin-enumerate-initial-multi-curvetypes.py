...
for sequence in listconfigs:
    ...
    for j in range(len(kh_list)): 
        ...
        simtype = "emin"
        datascript = "stack-1species-mixed-curves"    # script to make data file with, NO .py EXTENSION
...
----------Deleting...""")
    ...
    if computer != "local" and ((len(series_simpaths) % 10 == 0) or (simcounter == len(listconfigs))):
