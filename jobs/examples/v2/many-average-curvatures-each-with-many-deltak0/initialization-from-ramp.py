...
kh_list = yaml_data['initial_kh']    # jobs that will run in series (must be list)
...
jobcounter = 0
check_sim_counter_interval = 15
time_between_intervals = 0.5 * 60 #minutes * conversion to seconds
    ...
    for j in range(len(kh_list)):  
        ...
        for pattern in pattern_list:
            ...
            for curvetypes in curvetypes_list:
                ...
                if (simcounter % check_sim_counter_interval) == 0:
                    time.sleep(time_between_intervals)
